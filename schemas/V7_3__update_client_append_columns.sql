...
ALTER TABLE ${schemaName}.client_append
    DROP COLUMN check_do_not_call;
ALTER TABLE ${schemaName}.client_append
    DROP COLUMN return_do_not_call_phone;
...
ALTER TABLE ${schemaName}.client_append
    ADD COLUMN check_do_not_call BOOLEAN;
ALTER TABLE ${schemaName}.client_append
    ADD COLUMN return_do_not_call_phone BOOLEAN;
...
UPDATE ${schemaName}.append SET check_do_not_call = TRUE WHERE name = 'landlinePhone';
UPDATE ${schemaName}.append SET return_do_not_call_phone = FALSE WHERE name = 'landlinePhone';
UPDATE ${schemaName}.append SET check_do_not_call = TRUE WHERE name = 'wirelessPhone';
UPDATE ${schemaName}.append SET return_do_not_call_phone = FALSE WHERE name = 'wirelessPhone';
